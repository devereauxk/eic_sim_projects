...
C..MDB..Recoil from primordial kt split chi:1-chi, not 50:50%
          P(IS(JT)+1,1)=P(IS(JT)+1,1)+(0.5D0-CHI(JT))*P(MINT(83)+JT+2,1)
          P(IS(JT)+1,2)=P(IS(JT)+1,2)+(0.5D0-CHI(JT))*P(MINT(83)+JT+2,2)
          P(IS(JT),1)=P(IS(JT),1)-(0.5D0-CHI(JT))*P(MINT(83)+JT+2,1)
          P(IS(JT),2)=P(IS(JT),2)-(0.5D0-CHI(JT))*P(MINT(83)+JT+2,2)
          PMS(JT+2)=P(IS(JT),5)**2+P(IS(JT),1)**2+P(IS(JT),2)**2
          PMS(JT+4)=P(IS(JT)+1,5)**2+P(IS(JT)+1,1)**2+P(IS(JT)+1,2)**2
C...MDB

...
ln -s /eic/u/kdevereaux/work/multiplicity/condor/eCa_18_110/inputFiles/eC.inp
...
echo "Cleaning Up..."
mv -v eC.txt /eic/u/kdevereaux/work/multiplicity/condor/eCa_18_110/outForPythiaMode/eC_${INPUT}.txt
mv -v eC.root /eic/u/kdevereaux/work/multiplicity/condor/eCa_18_110/outForPythiaMode/eC_${INPUT}.root
mv -v eC.log /eic/u/kdevereaux/work/multiplicity/condor/eCa_18_110/logs/eC_${INPUT}.log
echo "DONE!!!"

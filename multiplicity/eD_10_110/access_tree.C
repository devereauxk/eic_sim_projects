...
void access_tree(const char* inFile, const char* outFile)
{
  ...
  TH2D* h2d_proton = new TH2D("h2d_proton","proton/antiproton multiplicity",15, -0.5, 14.5, 15, -0.5, 14.5);
  ...
  TH1D* h1d_proton = new TH1D("h1d_proton_total","proton/antiproton multiplicity",15,-0.5,14.5);

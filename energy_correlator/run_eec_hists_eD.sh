...
OUT_DIR=/eic/u/kdevereaux/work/energy_correlator/eHIJING/eD_10_100_K4_pow05
...
#                                                                                                        DOUBLE CHECK THESE
#                                                                                                        power, boost, Q2x
root -l -b -q "eec_hists.C(\"eD_${INPUT}.dat\",\"$OUT_DIR/hists_eec_${INPUT}.root\", 1, 2130.17, 100, 4, 0.5, 1, 1)"

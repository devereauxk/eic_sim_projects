...
OUT_DIR=/eic/u/kdevereaux/work/energy_correlator/eHIJING/eCa_10_100_K4
...
root -l -b -q "eec_hists.C(\"eCa_${INPUT}.dat\",\"$OUT_DIR/hists_eec_${INPUT}.root\", 1, 2129.82, 100, 5, 1)"

#!/bin/bash
IN_DIR=/eic/u/kdevereaux/work/eHIJING/eHIJING-pythia/eHIJING-examples/Events/eAu_10_100_pdf0
OUT_DIR=/eic/u/kdevereaux/work/energy_correlator/eHIJING/eAu_10_100_pdf0

#!/bin/bash
IN_DIR=/eic/u/kdevereaux/work/eHIJING/eHIJING-pythia/eHIJING-examples/Events/eAu_18_110_K4
OUT_DIR=/eic/u/kdevereaux/work/energy_correlator/eHIJING/eAu_18_110_K4

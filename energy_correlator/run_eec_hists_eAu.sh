#!/bin/bash
IN_DIR=/eic/u/kdevereaux/work/eHIJING/eHIJING-pythia/eHIJING-examples/Events/eAu_5_41_K0
OUT_DIR=/eic/u/kdevereaux/work/energy_correlator/eHIJING/eAu_5_41_K0

...
OUT_DIR=/eic/u/kdevereaux/work/e3c/toy_model_kstudies/Qs0p2
...
root -l -b -q "e3c_hists.C(\"ep_${INPUT}.dat\",\"$OUT_DIR/hists_eec_${INPUT}.root\", 1, 2131.56, 100, 0, 1, 1, 1, 0.2)"

...
OUT_DIR=/eic/u/kdevereaux/work/e3c/analysis/ep_10_100_K0_density_pow15
...
#                                                                                                        DOUBLE CHECK THESE
#                                                                                                        power, boost, Q2x
root -l -b -q "e3c_hists.C(\"ep_${INPUT}.dat\",\"$OUT_DIR/hists_eec_${INPUT}.root\", 1, 2131.56, 100, 0, 1.5, 1, 1)"

...
EP_DIR=./BeAGLE_v102/eC_10_100_qhat0_nlo
...
root -l -q "plot_chadron_gen.C(\"$EP_DIR/outForPythiaMode/ana_merged.root\", 0, 1, \"$EA_DIR/outForPythiaMode/ana_merged.root\", 4, 1, \"$EA_DIR/figs_norm_0/hists_gen.root\", 0)"

...
root -l -q "plot_chadron_gen.C(\"$EP_DIR/outfiles/ana_merged.root\", 0, 1, \"$EA_DIR/outForPythiaMode/ana_merged.root\", 5, 1, \"$EA_DIR/figs_norm_0/hists_gen.root\", 0)"
mv figs/* $EA_DIR/figs_norm_0
rm -r figs

mkdir figs
mkdir $EA_DIR/figs_norm_1
root -l -q "plot_chadron_gen.C(\"$EP_DIR/outfiles/ana_merged.root\", 0, 1, \"$EA_DIR/outForPythiaMode/ana_merged.root\", 5, 1, \"$EA_DIR/figs_norm_1/hists_gen.root\", 1)"

...
mkdir figs
mkdir $EA_DIR/figs
root -l -q "plot_chadron_gen.C(\"$EP_DIR/outfiles/ana_merged.root\", 0, 1, \"$EA_DIR/outForPythiaMode/ana_merged.root\", 5, 1, \"$EA_DIR/figs/hists_gen.root\")"
mv figs/* $EA_DIR/figs
rm -r figs
mv $EA_DIR/figs $EA_DIR/figs_norm_0

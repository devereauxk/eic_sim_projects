...
EA_DIR=./BeAGLE_v102/eAu_10_100_equivalent
...
root -l -q "plot_chadron_gen.C(\"$EP_DIR/outfiles/ana_merged.root\", 0, 1, \"$EA_DIR/outForPythiaMode/ana_merged.root\", 1, 1, \"$EA_DIR/figs/hists_gen.root\", 0)"
mv figs/* $EA_DIR/figs_norm_0
rm -r figs

mkdir figs
mkdir $EA_DIR/figs_norm_1
root -l -q "plot_chadron_gen.C(\"$EP_DIR/outfiles/ana_merged.root\", 0, 1, \"$EA_DIR/outForPythiaMode/ana_merged.root\", 1, 1, \"$EA_DIR/figs/hists_gen.root\", 1)"

...
void inc_hadron_gen(const char* inFile = "merged.root", const char* outFile = "inc_hadron.root", int nevt = 0, int data_type = 0, int gen_type = 0)
{
  ...
  TH3D* h3d_event_Ninc_vs_thickness_vs_b = new TH3D("h3d_event_Ninc_vs_thickness_vs_b","Ninc vs thickness vs b",100,0,10,100,0,10,100,0,10);
  h3d_event_Ninc_vs_thickness_vs_b->Sumw2();
  TH3D* h3d_event_Nincch_vs_thickness_vs_b = new TH3D("h3d_event_Nincch_vs_thickness_vs_b","Nincch vs thickness vs b",100,0,10,100,0,10,100,0,10);
